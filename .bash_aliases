...
alias fx-db='docker run -it --rm --link fxdata:mysql mariadb sh -c '"'"'exec mysql -h"$MYSQL_PORT_3306_TCP_ADDR" -P"$MYSQL_PORT_3306_TCP_PORT" -ufxdata -p"$MYSQL_ENV_MYSQL_FXDATA_PASSWORD" fxdata'"'"''
