...
alias g='googler'
alias fx-shell='touch $HOME/fx-shell.bash_history;docker run -ti --rm --link fxdatafeed:mysql --link smtp:smtp -v $HOME/fx/cfg:/etc/fxtrader -v $HOME/fx-shell.bash_history:/root/.bash_history -v ~/src:/src -h fx-shell fxtrader/finance-hostedtrader bash'
